...
module.exports = {
  ...
  manifestFirefoxJson: resolveApp('public/manifest.firefox.json'),
  appOptionsHtml: resolveApp('public/options.html'),
  appPopupHtml: resolveApp('public/popup.html'),
  appDevtoolHtml: resolveApp('public/devtool.html'),
  ...
  appDevtoolJs: resolveModule(resolveApp, 'src/devtool/index'),
