...
With the function **morfeo** you can handle the theme object and resolve a [morfeo style object](../theme-specification.mdx#morfeo-style-object) info a valid css-in-js object.
...
In this example we are using the property "px" that it's an alias for **paddingLeft** and **paddingRight**, check all the aliases [here](../theme-specification.mdx#properties)
