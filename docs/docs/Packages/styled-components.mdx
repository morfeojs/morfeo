...
:::info
If you need to know more about **@morfeo** theme definition and initialization, reading [@morfeo/spec](../ThemeSpecification/overview.mdx) docs is highly recommended.
:::
