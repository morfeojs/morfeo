...
- [Web Extension](../Features/web-extension.mdx)
...
- set a theme, you can create your own (following our [theme specification](../ThemeSpecification/overview.mdx)) or use our [preset](../Packages/preset-default.mdx)
...
- Use it everywhere to resolve a [morfeo style object](../ThemeSpecification/overview.mdx#morfeo-style-object) into a valid `css-in-js` object:
