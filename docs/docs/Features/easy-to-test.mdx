...
:::info
The following examples are made using `jest` and `@testing-library/react` and the components are made in `React` but you can apply the same rules and principles to other frameworks too.
:::
