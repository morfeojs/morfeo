...
Based on the options passed to `createMorfeo` you can customize Morfeo's behavior, for example you can give a `custom theme` or a custom `prefix` for you class names:
