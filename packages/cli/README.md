...
@morfeo/cli/0.5.0 darwin-x64 node-v14.16.0
$ morfeo --help [COMMAND]
USAGE
  $ morfeo COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/morfeojs/morfeo/blob/v0.5.0/lib/commands/build.js)_
...
_See code: [lib/commands/compose.js](https://github.com/morfeojs/morfeo/blob/v0.5.0/lib/commands/compose.js)_
